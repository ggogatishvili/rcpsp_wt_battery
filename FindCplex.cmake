...
if (NOT DEFINED CPLEX_DIR AND DEFINED ENV{CPLEX_HOME})
...
find_library(Cplex_LIBRARY
        NAMES cplex
        HINTS ${CPLEX_DIR} $ENV{CPLEX_HOME}
        PATH_SUFFIXES cplex/lib/x86-64_linux/static_pic cplex/lib/x86-64_osx/static_pic cplex/lib/arm64_osx/static_pic lib)
...
find_library(Cplex_Concert_LIBRARY
        NAMES concert
        HINTS ${CPLEX_DIR} $ENV{CPLEX_HOME}
        PATH_SUFFIXES concert/lib/x86-64_linux/static_pic concert/lib/x86-64_osx/static_pic concert/lib/arm64_osx/static_pic lib)

find_library(Cplex_ConstraintProgramming_LIBRARY
        NAMES cp
        HINTS ${CPLEX_DIR} $ENV{CPLEX_HOME}
        PATH_SUFFIXES cpoptimizer/lib/x86-64_linux/static_pic cpoptimizer/lib/x86-64_osx/static_pic cpoptimizer/lib/arm64_osx/static_pic lib)
...
find_package_handle_standard_args(Cplex
        REQUIRED_VARS Cplex_INCLUDE_DIR Cplex_Concert_INCLUDE_DIR Cplex_LIBRARY Cplex_Ilo_LIBRARY Cplex_Concert_LIBRARY)
...
mark_as_advanced(Cplex_INCLUDE_DIR Cplex_LIBRARY Cplex_Ilo_LIBRARY Cplex_Concert_INCLUDE_DIR Cplex_Concert_LIBRARY)
